# E-commerce Project
This project simulates a **real-world e-commerce analytics pipeline**, from synthetic **data generation** to **SQL analysis** and **Power BI dashboards**.
...
![ER diagram](images/ER-diagam.png)
