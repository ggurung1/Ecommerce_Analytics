...
NUM_ORDERS=int(input(f'ENTER TOTAL NUMBER OF ORDERS:(> than number of customers {NUM_CUSTOMERS})'))
...
with open("ecommerce_data.sql","w") as f:
	...
	#Orders
	f.write("INSERT INTO orders (customer_id,order_date,order_status,shipped_date,delivered_date,tax_amount,shipping_fee,discount_amount,order_total) VALUES\n")
	f.write(",\n".join([f"({o[1]},'{o[2]}','{o[3]}',{sql_date(o[4])},{sql_date(o[5])},{o[6]},{o[7]},{o[8]},{o[9]})" for o in orders]))
	f.write(";\n\n")
